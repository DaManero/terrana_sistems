  ...
  if (estado === 'success') {
    return (
      <div className="text-center space-y-3">
        ...
        <h2 className="text-xl font-semibold text-stone-800">¡Contraseña actualizada!</h2>
    ...
    <main className="min-h-screen bg-stone-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-sm border border-stone-200 p-8 space-y-6">
        <div className="text-center space-y-1">
          <h1 className="text-2xl font-bold text-stone-800">Restablecer contraseña</h1>
          <p className="text-stone-500 text-sm">Ingresá tu nueva contraseña</p>
        </div>
